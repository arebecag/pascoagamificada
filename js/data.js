...
// Exposição explícita para evitar problemas de escopo entre scripts em alguns ambientes de deploy.
if (typeof globalThis !== 'undefined') {
  Object.assign(globalThis, {
    PALETA,
    TOTAIS,
    EVOLUCAO_DIARIA_GERAL,
    EVOLUCAO_DIARIA_CAMPANHA,
    RANKING_LOJAS_DENTRO,
    SALES_DENTRO_MAP,
    RANKING_DENTRO,
    PODIO_TOP3,
    LOJAS_OPERACIONAL,
    PODIO_TOP3_LOJAS,
    RESULTADO_GAMIFICACAO_LOJA,
    RANKING_PRODUTOS_GAMIFICACAO,
    PRODUTOS_CAMPANHA
  });
}
